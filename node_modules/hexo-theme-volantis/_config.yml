...
navbar:
  ...
  logo: # choose [img] or [icon + title]
    img: https://koroshiya-image-host.oss-cn-shenzhen.aliyuncs.com/logo2.png
    icon:
    title:
  menu:
    - name: 主页
  ...
  search: 听着音乐来一杯？  # Search bar placeholder
############################### Navigation Bar ############################### > end
...
cover:
  ...
  background: https://koroshiya-image-host.oss-cn-shenzhen.aliyuncs.com/郊外s.png
  #https://w.wallhaven.cc/full/pk/wallhaven-pkoe53.jpg
  ...
  title: '酒精中毒'
  subtitle: '关于酒、游戏、音乐，以及一切'
  search: A Wonderful Theme for Hexo # search bar placeholder
  features:
    - name: 孑立酒单
      icon: #
      img: https://koroshiya-image-host.oss-cn-shenzhen.aliyuncs.com/cocktails.png
      url: /drinkingMenu/
    - name: 游戏评介
      icon: #
      img: https:/koroshiya-image-host.oss-cn-shenzhen.aliyuncs.com/gamepad playstation.png
      url: /gameRec/
    - name: 开发日志
      icon: #
      img: https://koroshiya-image-host.oss-cn-shenzhen.aliyuncs.com/unity.png
      url: /developLog/
    - name: 文章推荐
      icon: #
      img: https://koroshiya-image-host.oss-cn-shenzhen.aliyuncs.com/brandBook.png
      url: /articleRec/
...
article:
  ...
  body:
    ...
    meta_library:
      ...
      author:
        avatar: https://tva4.sinaimg.cn/large/007CzvoTgy1gqh71o7ynuj30rs0rsnpd.jpg
        name: Koroshiya
        url: /
      # 文章创建日期
      date:
...
sidebar:
  ...
  widget_library:
    ...
    blogger:
      ...
      social:
        - icon: fab fa-steam
          url: https://steamcommunity.com/id/2462801060/
        - icon: fas fa-envelope
          url: mailto:Koroshiya991125@gmail.com
        - icon: fab fa-github
          url: https://github.com/Koroshiya71/Slay-the-Touhou
        - icon: fas fa-headphones-alt
          url: https://music.163.com/#/playlist?id=58299090&userid=58427005
    # ---------------------------------------
...
plugins:
  ...
  aplayer:
    ...
    id: 6761408271    # song id / playlist id / album id / search keyword
    # Optional
    ...
    volume: 0.8       # default volume, notice that player will remember user setting, default volume will not work after user set volume themselves
...
rightmenu:
  enable: true
  # hr: 分割线, music: 音乐控制器
  layout: [home, source_docs, source_theme, hr, friend, hr, dark_mode]
  # 可选功能项
  # print:
  #   name: 打印页面
  #   icon: fa fa-print
  ...
  source_docs:
    ...
    url: https://github.com/Koroshiya71/KoroshiyaBlog
  source_theme:
    name: 主题源码
    icon: fa fa-code-branch
    url: https://github.com/volantis-x/hexo-theme-volantis/
  ...
  friend:
    ...
    url: https://gitee.com/koroshiya/Blog-Friends/issues
...
analytics:
  ...
  leancloud: # 请使用自己的 id & key 以防止数据丢失
    app_id: iYOAdlyror7naVvLczghrLCV-MdYXbMMI
    app_key: NHGfGTJq1ChjQyvpFMhrwHYJ
