...
cover:
  ...
  background: https://tvax2.sinaimg.cn/large/007CzvoTgy1gqgnl1u9q7j33uw1lwx6y.jpg
...
rightmenu:
  enable: true
  # hr: 分割线, music: 音乐控制器
  layout: [home, help, examples, contributors, hr, source_docs, source_theme, hr, print, hr, dark_mode, hr, music, hr, friend]
  # 可选功能项
  # print:
  #   name: 打印页面
  #   icon: fa fa-print
